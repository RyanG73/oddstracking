            ...
            if c['name'] == 'Game Lines':
                ...
                for m in markets:
                    ...
                    if 'label' in m and m['label'] == 'Total Points':
                        ...
                        for s in selections:
                            total = s['line']
                scrapeData.append([event_id,away_team,home_team,event_start,event_status,line,total])
    except:
        pass
df = pd.DataFrame(scrapeData, columns=['event_id','away_team','home_team','event_start','event_status','current_line','current_total'])
