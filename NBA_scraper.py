...
try:
    event_df = pd.read_csv('NBA_events.csv')
...
try:
    history = pd.read_csv('NBA_history.csv')
except:
...
history.to_csv('NBA_history.csv',index=False)
event.to_csv('NBA_events.csv',index=False)
